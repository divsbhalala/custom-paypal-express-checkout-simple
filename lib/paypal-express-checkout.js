...
Paypal.prototype.getExpressCheckoutDetails = function(token, doPayment, callback) {
  ...
  self.request(self.url, 'POST', params, function(err, data) {
    ...
    // params.PAYMENTREQUEST_0_SHIPTONAME= data.PAYMENTREQUEST_0_SHIPTONAME;
    // params.PAYMENTREQUEST_0_SHIPTOSTREET= data.PAYMENTREQUEST_0_SHIPTOSTREET;
    // params.PAYMENTREQUEST_0_SHIPTOSTREET2= data.PAYMENTREQUEST_0_SHIPTOSTREET2;
    // params.PAYMENTREQUEST_0_SHIPTOCITY= data.PAYMENTREQUEST_0_SHIPTOCITY;
    // params.PAYMENTREQUEST_0_SHIPTOSTATE='CA';
    // params.PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE='US';
    // params.PAYMENTREQUEST_0_SHIPTOZIP= data.PAYMENTREQUEST_0_SHIPTOZIP;
    // params.PAYMENTREQUEST_0_EMAIL='jsmith01@example.com';
    // params.PAYMENTREQUEST_0_SHIPTOPHONENUM='408-559-5948';   
...
Paypal.prototype.setExpressCheckoutPayment = function(email, invoiceNumber, amount, totalShipCost, description, currency, returnUrl, cancelUrl, onlyPayPalUsers, shipAddress , callback) {
  ...
  params.PAYMENTREQUEST_0_AMT = Math.round((amount + totalShipCost) * p) / p;
  ...
  params.PAYMENTREQUEST_0_SHIPPINGAMT = prepareNumber(totalShipCost);
